					        ...
					        <div class="form-horizontal form-label-left">
					        	...
					        	<div class="form-group">
					        		...
					        		<div class="col-md-4 col-sm-6 col-xs-12">
					        			<input type="text" title="Nama pengadaan" class="form-control search_group" id="search_group">
					        		</div>
							...
							<div class="col-md-12">
								...
								<table class="mandaysTable_view table table-bordered table-responsive table-hover">
									...
									<tbody class="t_pencarian">
										...
										<tr>
											<td><center>{{ $datas->id_group }}</center></td>
											<td>{{ $datas->nama_group }}</td>
											<td>{{ $datas->des_group  }}</td>
											<td>
												<center>
												<div class="input-group">
													<button type="button" class="btn btn-warning button_edit" data-toggle="modal" value="{{ $datas->nama_group }}*{{ $datas->id_group }}*{{ $datas->des_group  }}">Edit<i class="fa fa-fw fa-edit"></i></button>&nbsp
													<button type="button" class="btn btn-danger button_delete_project" id="delete_grup"value="{{ $datas->nama_group }}*{{ $datas->des_group }}">Delete<i class="fa fa-close"></i> </button>
												</div>
												</center>
											</td>
										</tr>
												...
												<div class="modal-content animated bounceInRight">
													...
													<div class="form-horizontal">{{csrf_field()}}
															...
															<div class="form-group">
																...
																<div class="col-md-6 col-sm-9 col-xs-12">
																	<textarea  class="form-control grdes"  id="grdes" style="resize: none;" value="">{{ $datas->des_group }}</textarea>
																</div>
															</div>
						        ...
						        <form class="form-horizontal" method="post" action="{{url('insert')}}">
									<div class="modal-body">
										<div class="form-group">
											<label class="control-label col-md-4 col-sm-6 col-xs-12">Group name</label>
											<div class="col-md-6 col-sm-9 col-xs-12">
												<input name="grname" type="text" class="form-control grname" id="grname" placeholder="Enter Group name"value="">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-4 col-sm-6 col-xs-12">Group description</label>
        ...
        $(document).ready(function() {
            ...
            $('.btn-edit-group').click(function(){
                ...
                $.ajax({
                    ...
                    data  : {'group_id':String_id_group,'nama_group':String_nama_group,'des_group':String_des_group,_token: '{{csrf_token()}}'},
                    dataType: 'json',
                    beforeSend: function(){
            ...
            $('#btn_delete_group').click(function(){
	            ...
	            var String_nama_group      = $("#grname").val();
	            var String_des_group       = $("#grdes").val();
	            var val = {'grname': String_nama_group, 'grdes' : String_des_group, _token :'{{csrf_token()}}'};  
				...
				$('.btn-search-group').click(function(){
				       ...
				       var val = {'search_group': grname, 'grdes' : grdes, _token :'{{csrf_token()}}'};  
				        {
