                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <center>
                                                        <button type="button" class="btn btn-warning button_edit" data-toggle="modal" value="{{ $vendors->id_vdr }}*{{ $vendors->Reason }}*{{ $vendors->Start }}*{{ $vendors->End }}*{{ $vendors->Evidence }}">Edit<i class="fa fa-fw fa-edit"></i></button>
                                                        <button type="button" class="btn btn-danger delete_black" id="btn_delete_black"value="{{ $vendors->Vendor }}">Delete<i class="glyphicon glyphicon-trash"></i></button>
                                                    </center>
                                                </div>
                                            </td>
                                        </tr>
...
<script type="text/javascript">
     ...
     $('.btn-search-black').click(function(){
       ...
       var val = {'search_black': black, 'vendor' : vendor, _token :'{{csrf_token()}}'};  
        {
