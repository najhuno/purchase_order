							      	...
							      	<div class="x-content">
										<table class="mandaysTable_view table table-bordered table-responsive table-hover">
										  ...
										  <tbody class ="t_pencarian">
												<?php $__currentLoopData = $monitoring; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monitorings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       		<tr>
                                            <td><center><?php echo e($monitorings->id_monitoring); ?></center></td>
                                            <td><?php echo e($monitorings->direktorat_bisnis); ?></td>
                                            <td><?php echo e($monitorings->unit_kerja); ?></td>
                                            <td><?php echo e($monitorings->janis_anggaran); ?></td>
                                            <td><?php echo e($monitorings->paket_pengadaan); ?></td>
                                            <td><?php echo e($monitorings->status); ?></td>
											<td>
											<div class="input-group">
											<center>
												 <button type="button" class="btn btn-warning button_edit3" data-toggle="modal" value="<?php echo e($monitorings->id_monitoring); ?>*<?php echo e($monitorings->janis_anggaran); ?>">Edit<i class="fa fa-fw fa-edit"></i></button>

												 <button type="button" class="btn btn-danger delete_toring" id="btn_delete_toring"value="<?php echo e($monitorings->id_monitoring); ?>*<?php echo e($monitorings->paket_pengadaan); ?>">Delete<i class="fa fa-close"></i> </button>
											</center>
										</div>
									</td>
								</tr>
                                                     ...
                                                     <label class="control-label col-md-4 col-sm-6 col-xs-12">paket_pengadaan</label>
                                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="form-control prjctname" readonly="readonly">
                                                                <option><?php echo e($monitorings->paket_pengadaan); ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
             ...
             $('.button_edit3').click(function(){
              ...
              $('.btn-edit-monitoring').click(function(){
                ...
                $.ajax({
                    ...
                    data  : {'id_monitoring':String_id_monitoring,'janis_anggaran':String_janis_anggaran,_token: '<?php echo e(csrf_token()); ?>'},
                    dataType: 'json',
                    beforeSend: function(){
        ...
        $('.btn-cari-toring').click(function(){
               ...
               var val = {'search_toring': toring, 'Anggaran' : Anggaran, _token :'<?php echo e(csrf_token()); ?>'};  
                {
            ...
            $('.btn_delete_toring').click(function(){
                    ...
                    var val = {'id_monitor' : id_monitor, _token :'<?php echo e(csrf_token()); ?>'};  
