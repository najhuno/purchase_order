  ...
  $('#filter-subunit').change(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(item, function(index,valuee) {        
                $fnama.append("<option value='"+valuee.Nama+"'>"+valuee.Nama+"</option>");
            });
...
function initializeTables(){
  ...
  table.el = $(table.id).DataTable({
        ...
        buttons: {
          ...
          buttons: [
              {extend: 'csv', title: 'Absensi Bulanan', className: 'btn btn-default'},
              {extend: 'pdf', title: 'Absensi Bulanan', className: 'btn btn-default'},
              {extend: 'print', title: 'Absensi Bulanan', className: 'btn btn-default',
        ...
        processing: true,
        ajax: {
          url: base_url+'karyawan/ajax_list_bulanan',
          method: 'POST',
          data : function(data){
