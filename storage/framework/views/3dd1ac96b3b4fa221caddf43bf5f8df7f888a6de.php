                                    ...
                                    <table class="mandaysTable_view table table-bordered table-responsive table-hover">
                                      ...
                                      <td>
                                        ...
                                        <div class="input-group">
                                              ...
                                              <button type="button" class="btn btn-warning button_edit" data-toggle="modal" value="<?php echo e($datas->id_ord); ?>*<?php echo e($datas->Nama_pengadaan); ?>*<?php echo e($datas->Pola_pengadaan); ?>*<?php echo e($datas->Tanggal); ?>*<?php echo e($datas->Keterangan); ?>">Edit<i class="fa fa-fw fa-edit"></i></button>&nbsp

                                              <button type="button" class="btn btn-danger delete_inisiasi" id="btn_delete_inisiasi"value="<?php echo e($datas->Nama_pengadaan); ?>">Delete<i class="glyphicon glyphicon-trash"></i> </button>
            ...
            $('.button_edit').click(function(){
             ...
             $('.btn-edit-inisiasi').click(function(){
                ...
                $.ajax({
                    ...
                    data  : {'id_ord':String_id_ord,'Nama_pengadaan':String_nama,'Pola_pengadaan':String_nama_group,'date1':String_tgl_closing,_token: '<?php echo e(csrf_token()); ?>'},
                    dataType: 'json',
                    beforeSend: function(){
             ...
             $('.delete_inisiasi').click(function(){
              ...
              $('.btn_delete_inisiasi').click(function(){
                    ...
                    var val = {'id_inisiasi' : id_inisiasi, _token :'<?php echo e(csrf_token()); ?>'};  
