					        ...
					        <div class="form-horizontal form-label-left">
								<div class="x-content">
									<table class="mandaysTable_view table table-bordered table-responsive table-hover">
                                        ...
                                        <tr>
                                            <td><center><?php echo e($datas->id_category); ?></center></td>
                                            <td><?php echo e($datas->Nama_category); ?></td>
                                            <td>
                                                <center>
                                                    <div class="input-group">
                                                        <button type="button" class="btn btn-warning button_edit" data-toggle="modal" value="<?php echo e($datas->id_category); ?>*<?php echo e($datas->Nama_category); ?>">Edit<i class="fa fa-fw fa-edit"></i></button>&nbsp
                                                        <button type="button" class="btn btn-danger button_delete_category" value="<?php echo e($datas->Nama_category); ?>">Delete<i class="fa fa-close"></i> </button>
                                                    </div>
                                                </center>
                                            </td>
                                        </tr>
            ...
            $('#btn-input-category').click(function(){
                ...
                if( Nama_category == ""){
                   ...
                   $.ajax({
                        ...
                        type: 'POST',
                        data: {'Nama_category': Nama_category,_token: '<?php echo e(csrf_token()); ?>'},
                        dataType: 'json',
                        success:function(r){
             ...
             $('.btn-edit-category').click(function(){
                ...
                $.ajax({
                    ...
                    data  : {'id_category':String_id_category,'Nama_category':String_Nama_category,_token: '<?php echo e(csrf_token()); ?>'},
                    dataType: 'json',
                    beforeSend: function(){
              ...
              $('#btn_delete_categori').click(function(){
                ...
                var val = {'id_category': String_id_category, _token :'<?php echo e(csrf_token()); ?>'};  
