...
function initializeTables(){
  ...
  table.el = $(table.id).DataTable({
        ...
        buttons: {
          ...
          buttons: [
              {extend: 'csv', title: 'Absensi Harian', className: 'btn btn-default'},
              {extend: 'pdf', title: 'Absensi Harian', className: 'btn btn-default'},
              {extend: 'print', title: 'Absensi Harian', className: 'btn btn-default',
