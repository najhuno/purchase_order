									...
									<tbody class ="t_pencarian">
                                      ...
                                      <td>
                                        ...
                                        <div class="input-group">
                                              ...
                                              <button type="button" class="btn btn-danger delete_closing" id="btn_delete_closing"value="<?php echo e($datas->paket_pengadaan); ?>">Delete<i class="glyphicon glyphicon-trash"></i> </button>
                                          </div>
                                          </center>
                                        </td>
                                      </tr>
                  											      ...
                  											      <div class="form-group">
                  											        <label class="control-label col-md-4 col-sm-4 col-xs-12">BAST</label>
                  												        <div class="col-md-4 col-sm-6 col-xs-12">
                  												          	<input type="text" class="form-control keterangan" id="keterangan" value="<?php echo e($datas->keterangan); ?>">
                  												        </div>
...
<script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.btn_delete_closing').click(function(){
                    ...
                    var val = {'id_clos' : id_closing, _token :'<?php echo e(csrf_token()); ?>'};  
  ...
  $('.btn-cari-closing').click(function(){
       ...
       var val = {'cari_closing': cari, 'paket_pengadaan' : paket_pengadaan, _token :'<?php echo e(csrf_token()); ?>'};  
        {
  ...
  $('#btn-input-closing').click(function(){
    ...
    // console.log(tgl_closing);
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {'paket_pengadaan': paket_pengadaan,'tgl_closing': tgl_closing,'keterangan': keterangan, _token: '<?php echo e(csrf_token()); ?>'},
                dataType: 'json',
                success:function(r){
